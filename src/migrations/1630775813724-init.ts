...
export class init1630775813724 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "poc"."dbo"."description" ("pid" bigint NOT NULL IDENTITY(1,1), "id" bigint NOT NULL, "effectiveTime" varchar(10), "active" bit, "moduleId" varchar(50), "conceptId" varchar(50), "languageCode" varchar(10), "typeId" varchar(50), "term" nvarchar(1000), "caseSignificanceId" varchar(50), CONSTRAINT "PK_afee2ebe290199c052a015e1fc5" PRIMARY KEY ("pid"))`
    );
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_7e36bc1b07a006bbd4d4fa98e5" ON "poc"."dbo"."description" ("conceptId") `
    );
    ...
    await queryRunner.query(
      `CREATE TABLE "poc"."dbo"."stated_relationship" ("pid" bigint NOT NULL IDENTITY(1,1), "id" bigint NOT NULL, "effectiveTime" varchar(10), "active" bit, "moduleId" varchar(50), "sourceId" varchar(50), "destinationId" varchar(50), "relationshipGroup" varchar(50), "typeId" varchar(50), "characteristicTypeId" varchar(50), "modifierId" varchar(50), CONSTRAINT "PK_27208da721cea72faa43317f17f" PRIMARY KEY ("pid"))`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_51775280d921828584394e4769" ON "poc"."dbo"."stated_relationship" ("id") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_bf7343ec8e10777f51c8056d0a" ON "poc"."dbo"."stated_relationship" ("moduleId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_700cbac50efefe436cac052a88" ON "poc"."dbo"."stated_relationship" ("sourceId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_3036a0494e81f9803e93f6b50f" ON "poc"."dbo"."stated_relationship" ("destinationId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_482c5cebf3ce2ecabcd7f11ffa" ON "poc"."dbo"."stated_relationship" ("typeId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_8cbe400ff18c032306172be43e" ON "poc"."dbo"."stated_relationship" ("characteristicTypeId") `
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_1d11aff58f7d1788b8aecd58d5" ON "poc"."dbo"."stated_relationship" ("modifierId") `
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "IDX_1d11aff58f7d1788b8aecd58d5" ON "poc"."dbo"."stated_relationship"`);
    await queryRunner.query(`DROP INDEX "IDX_8cbe400ff18c032306172be43e" ON "poc"."dbo"."stated_relationship"`);
    await queryRunner.query(`DROP INDEX "IDX_482c5cebf3ce2ecabcd7f11ffa" ON "poc"."dbo"."stated_relationship"`);
    await queryRunner.query(`DROP INDEX "IDX_3036a0494e81f9803e93f6b50f" ON "poc"."dbo"."stated_relationship"`);
    await queryRunner.query(`DROP INDEX "IDX_700cbac50efefe436cac052a88" ON "poc"."dbo"."stated_relationship"`);
    await queryRunner.query(`DROP INDEX "IDX_bf7343ec8e10777f51c8056d0a" ON "poc"."dbo"."stated_relationship"`);
    await queryRunner.query(`DROP INDEX "IDX_51775280d921828584394e4769" ON "poc"."dbo"."stated_relationship"`);
    await queryRunner.query(`DROP TABLE "poc"."dbo"."stated_relationship"`);
    ...
    await queryRunner.query(`DROP INDEX "IDX_7e36bc1b07a006bbd4d4fa98e5" ON "poc"."dbo"."description"`);
